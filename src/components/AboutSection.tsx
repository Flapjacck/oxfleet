  ...
  return (
    <section className="py-16 bg-linear-to-br from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-[#111111] mb-5 tracking-wide">
            WHY CHOOSE OX FLEETCARE
          </h2>
          <p className="text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed font-medium">
            Expert fleet care with proven results and unmatched service
          </p>
        </motion.div>
        ...
        >
          <div className="p-8 bg-linear-to-br from-[#111111] to-[#1a1a1a] text-white rounded-2xl shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] transition-all duration-500 hover:scale-[1.02]">
            ...
            <p className="text-gray-200 leading-relaxed text-lg">
              Optimizing fleet performance through proactive maintenance and expert service that keeps your operations running smoothly.
            </p>
          </div>
          <div className="p-8 bg-linear-to-br from-[#f15a29] to-[#d94d1f] text-white rounded-2xl shadow-2xl hover:shadow-[0_20px_60px_-15px_rgba(241,90,41,0.5)] transition-all duration-500 hover:scale-[1.02]">
            ...
            <p className="text-white leading-relaxed text-lg">
              Industry leadership in fleet care through innovation, service excellence, and building strong communities.
            </p>
          </div>
        </motion.div>
      </div>
